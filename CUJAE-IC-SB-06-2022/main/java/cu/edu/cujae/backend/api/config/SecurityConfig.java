...
import cu.edu.cujae.backend.core.security.ImageAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AuthenticationManager authenticationManagerBean() throws Exception {
    	ImageAuthenticationProvider provider = new ImageAuthenticationProvider();
	...
	public void configure(WebSecurity web) throws Exception {
		...
		.antMatchers("/swagger-ui/**", "/webjars/**", "/swagger-resources/**", "/v2/api-docs**", "/api/v1/auth**", "/images/**");
	}
